 ...
 public function setObjEquipo2($objEquipo2){
    ...
    public function darEquipoGanador(){
        if($this->getCantGolesE1()>$this->getCantGolesE2()){
            ...
            $equipoGanador=$this->getObjEquipo1()." y ".$this->getObjEquipo2();
        }
            return $equipoGanador;
    }

    public function coeficientePartido(){
        $golesPartido=$this->getCantGolesE1()+$this->getCantGolesE2();
        $cantJugadores1=$this->getObjEquipo1()->getCantJugadores();
        $cantJugadores2=$this->getObjEquipo2()->getCantJugadores();
        $coeBase = $this->getCoefBase() * $golesPartido * ($cantJugadores1 + $cantJugadores2);
        return $coeBase;
    }
